...
<p align="center">
  ...
  <a href="https://linkedin.com/in/youssefbrr"><img src="https://img.shields.io/badge/-LinkedIn-0A66C2?logo=linkedin&logoColor=white&style=flat-square" /></a>
  <a href="mailto:bourourouyoussef1@gmail.com"><img src="https://img.shields.io/badge/-Email-EA4335?logo=gmail&logoColor=white&style=flat-square" /></a>
  <img src="https://komarev.com/ghpvc/?username=youssefbrr&style=flat-square&color=blueviolet" />
</p>
...
| Skill | |
|---|---|
| LLM APIs (Claude, OpenAI) | ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰░ 92% |
| Agent Architectures & Tool Use | ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰░ 90% |
| Model Context Protocol (MCP) | ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰░░ 88% |
| RAG & Prompt Engineering | ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰░ 90% |
| Evals & Observability | ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰░░░ 85% |

## 🛠️ Tech Stack

**Backend & AI:** Node.js, NestJS, TypeScript, PostgreSQL, MongoDB, Prisma, Redis, Kafka, WebSocket

**Frontend:** React, Next.js, Redux, React Native

**DevOps & Observability:** Docker, GitHub Actions, Grafana, Prometheus, Loki

**Payments & Integrations:** Stripe Connect, MCP, LLM APIs
...
- Architected real-time collaboration using WebSockets and Yjs CRDTs
- Built fine-grained RBAC and permission management
...
<div align="center">
  <img src="https://streak-stats.demolab.com?user=youssefbrr&locale=en&mode=weekly&theme=onedark&hide_border=true" height="150" />
  <br/>
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=youssefbrr&theme=one-dark&radius=12&area=true&hide_border=true&hide_title=true" height="220" />
</div>
...
<p align="center">
  <a href="https://linkedin.com/in/youssefbrr"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?logo=linkedin&logoColor=white&style=for-the-badge" /></a>
...
<div align="center">
  <sub>⭐️ <em>Thanks for visiting! Explore my repos and feel free to reach out.</em></sub>
  <br/><br/>
